...
import { deleteBrand } from "@/app/(admin)/admin/marcas/actions";
    ...
    >
      ...
      >
        ...
        <p className="mt-2 text-sm text-muted">
          ¿Estás segura de que deseas eliminar la marca{" "}
          <strong className="text-text">&ldquo;{brandName}&rdquo;</strong>?
          El logo asociado también se eliminará. Esta acción no se puede
          deshacer.
        </p>
