...
import { deleteBanner } from "@/app/(admin)/admin/banners/actions";
    ...
    >
      ...
      >
        ...
        <p className="mt-2 text-sm text-muted">
          ¿Estás segura de que deseas eliminar el banner{" "}
          <strong className="text-text">&ldquo;{bannerTitle}&rdquo;</strong>?
