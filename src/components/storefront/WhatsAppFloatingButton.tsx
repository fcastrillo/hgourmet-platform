...
interface WhatsAppFloatingButtonProps {
  /** Override for testing or server-injected config. Defaults to SOCIAL_LINKS.whatsapp. */
  whatsappUrl?: string;
}

function isValidWhatsAppUrl(url: string | undefined): url is string {
  return Boolean(url && url.startsWith("https://wa.me/"));
}
