...
Uso:
    python borra-imagenes-desde.py          # modo simulacro (no borra nada)
    python borra-imagenes-desde.py --borrar # borra de verdad
"""
import os
import sys
import pandas as pd
...
if SIMULACRO:
    ...
    print(f"  python borra-imagenes-desde.py --borrar")
